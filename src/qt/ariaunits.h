...
#ifndef ARIA_QT_UNITS_H
#define ARIA_QT_UNITS_H
...
*/
class AriAUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AriAUnits(QObject* parent);

    /** AriA units.
      @note Source: https://en.AriA.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        ARA,
        mARA,
...
typedef AriAUnits::Unit AriAUnit;

#endif // ARIA_QT_UNITS_H
