                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zAriA || context == Context::BIP_38) {
        ui->anonymizationCheckBox->setChecked(true);
    }
    else {
        ui->anonymizationCheckBox->setChecked(false);
    }
     // It doesn't make sense to show the checkbox for sending AriA because you wouldn't check it anyway.
    if (context == Context::Send_AriA || context == Context::Send_zAriA) {
