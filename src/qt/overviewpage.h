...
#ifndef ARIA_QT_OVERVIEWPAGE_H
#define ARIA_QT_OVERVIEWPAGE_H
...
private:
    ...
    int nDisplayUnit;
    void getPercentage(CAmount nTotalBalance, QString& sARIAPercentage);
