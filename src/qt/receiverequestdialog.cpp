...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAriAURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + AriAUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAriAURI(info));
}
