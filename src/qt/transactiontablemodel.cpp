...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address") << AriAUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();
...
{
    columns[Amount] = AriAUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("AR Stake");
    case TransactionRecord::StakeZAriA:
        return tr("zAR Stake");
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord* wtx, bool showUnconfirmed, AriAUnits::SeparatorStyle separators) const
{
    QString str = AriAUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit, false, separators);
    if (showUnconfirmed) {
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, AriAUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, AriAUnits::separatorNever);
    case StatusRole:
