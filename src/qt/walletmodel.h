...
#ifndef ARIA_QT_WALLETMODEL_H
#define ARIA_QT_WALLETMODEL_H
...
/** Interface to AriA wallet from Qt view code. */
...
public:
    ...
    bool isMine(CAriAAddress address);
