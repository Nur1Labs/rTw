...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a rTw initiative\n"
            "  vote-alias         - Vote on a rTw initiative\n"
            "  vote               - Vote on a rTw initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            ...
            "5. \"aria-address\":   (string, required) rTw address to send payments to\n"
    ...
    CAriAAddress address(params[4].get_str());
    if (!address.IsValid())
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) rTw address of payment\n"
