...
static const CAriAAddress addr1 ("DBFi8XAE1rcdCQfkv9w22n8Y9RxgaJnrDD");
static const CAriAAddress addr2 ("DPvKfv1FVp69yZMDzeuugvfZ9pzYiMv1bs");
static const CAriAAddress addr1C("DNPrHK9ezAAUVExFDpZ7EE1xWpPskgp1gP");
static const CAriAAddress addr2C("DNBVSAoc2whPFjZVAZ1pQbXPJk1LRrDC8Q");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CAriAAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CAriASecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
