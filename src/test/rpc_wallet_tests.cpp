...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CAriAAddress demoAddress = CAriAAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CAriAAddress setaccountDemoAddress = CAriAAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CAriAAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAriAAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
