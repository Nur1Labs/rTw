...
#ifndef ARIA_WALLET_H
#define ARIA_WALLET_H
...
public:
    ...
    bool CreateZerocoinSpendTransaction(CAmount nValue, int nSecurityLevel, CWalletTx& wtxNew, CReserveKey& reserveKey, CZerocoinSpendReceipt& receipt, vector<CZerocoinMint>& vSelectedMints, vector<CZerocoinMint>& vNewMints, bool fMintChange,  bool fMinimizeChange, CAriAAddress* address = NULL);
    ...
    bool SpendZerocoin(CAmount nValue, int nSecurityLevel, CWalletTx& wtxNew, CZerocoinSpendReceipt& receipt, vector<CZerocoinMint>& vMintsSelected, bool fMintChange, bool fMinimizeChange, CAriAAddress* addressTo = NULL);
    ...
    bool CreateZAriAOutPut(libzerocoin::CoinDenomination denomination, libzerocoin::PrivateCoin& coin, CTxOut& outMint);
    ...
    */
    ...
    std::map<CAriAAddress, std::vector<COutput> > AvailableCoinsByAddress(bool fConfirmed = true, CAmount maxCoinValue = 0);
	...
	/** zAriA reset */
    boost::signals2::signal<void()> NotifyzAriAReset;
};
